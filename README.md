...
| Extension | `@amaster.ai/pi-video-gen` | AI video generation plus local composition: lossless clip concat and image-based timelines with overlays, TTS, subtitles, BGM, and bundled LGPL/GPL FFmpeg runtimes. |
